...
def generate_random_password():
    """Génère un mot de passe aléatoire composé de lettres minuscules et majuscules."""
...
def add_password():
    ...
    for hashed_pwd in passwords.values():
        if hashed_password == hashed_pwd:
            print("Le mot de passe que vous avez entré est déjà enregistré.")
            return
